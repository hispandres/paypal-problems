# paypal-problems
I'm having trouble setting up smart buttons for a payment processing page. 
I followed the steps on the integration guide and I'm still not receiving payment after getting the "thank you.."message, 
added sandbox api client id to sdk script tag on my code and now the buttons are not launching the form. 
...
input[type=number]::-webkit-outer-spin-button { 
  ...
  <script src="https://www.paypal.com/sdk/js?client-id=Af1IlBFvduDHptOzJQMuEdNGwcepCLLUlF6I8w9dhVkZnAZByo5eJ0RRVfgeBmaCN6wsugYK82XsAYFG&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory"></script>
  <script>
